...
Page({
  ...
  onLoad:function(options){
      ...
      var self=this;
      wx.request({
        url: aa.globalData.url+'/content/get',
        data: {
          https:0,
          format:1,
          id:options.id,
        ...
        success: function(res){
          ...
          flags=[]; 
          getFlagArrar(res.data.body.txt);
          //收藏
          console.log(res.data.body.txt);
   ...
   up:function(){//点赞
      ...
      var id=self.data.content.id;//内容id
   ...
   collect:function(){//收藏
      ...
      if(sessionKey==""||sessionKey==null){
       ...
       wx.request({
         url: aa.globalDataCollect.url+'/content/collect',
         data: {
           id:id,
           operate:operate,
           appId:appId,
