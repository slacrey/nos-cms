      ...
      <div class="content-fiexd">
         <el-button :disabled="disabled" @click="deleteBatch($api.contentDelete,ids)"
          ...
          <el-button :disabled="disabled" @click="batch($api.contentCheck)"
            v-perms="'/content/contentRecommend'"
          >审核</el-button>
          <el-button :disabled="disabled" @click="batch($api.contentReject)"
          ...
          >推送至专题</el-button>
          <el-button :disabled="disabled" @click="batch($api.contentPigeonhole)"
            v-perms="'/content/contentPigeonhole'"
          >归档</el-button>
          <el-button :disabled="disabled" @click="batch($api.contentUnpigeonhole)"
            v-perms="'/content/contentUnpigeonhole'"
          >出档</el-button>
