...
import static com.nos.cms.Constants.SNAP_PATH;
...
public class SnapScreenServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request,
		...
		try {
			String snapImageName=getSnapImageName("jpg");
	...
	private String getSnapImageName(String ext){
        return UploadUtils.generateFilename(SNAP_PATH, ext);
	}
