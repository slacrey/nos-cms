...
public abstract class BaseCmsConfigItem  implements Serializable {
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof com.nos.core.entity.CmsConfigItem)) return false;
		else {
			com.nos.core.entity.CmsConfigItem cmsConfigItem = (com.nos.core.entity.CmsConfigItem) obj;
            return !(null == this.getId() || null == cmsConfigItem.getId()) && (this.getId().equals(cmsConfigItem.getId()));
		}
	}
