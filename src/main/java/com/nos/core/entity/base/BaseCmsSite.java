...
public abstract class BaseCmsSite  implements Serializable {
	...
	public BaseCmsSite (
		...
		com.nos.core.entity.CmsConfig config,
	...
	// many to one
	private com.nos.core.entity.Ftp uploadFtp;
	private com.nos.core.entity.CmsConfig config;
	// one to one
	private com.nos.core.entity.CmsSiteCompany siteCompany;
	 ...
	 */
	public com.nos.core.entity.Ftp getUploadFtp () {
		return uploadFtp;
	}
	 ...
	 */
	public void setUploadFtp (com.nos.core.entity.Ftp uploadFtp) {
	 ...
	 */
	public com.nos.core.entity.CmsConfig getConfig () {
		return config;
	}
	 ...
	 */
	public void setConfig (com.nos.core.entity.CmsConfig config) {
		this.config = config;
	}
	
	public com.nos.core.entity.CmsSiteCompany getSiteCompany() {
		return siteCompany;
	}

	public void setSiteCompany(com.nos.core.entity.CmsSiteCompany siteCompany) {
	...
	public void setUserSites(
			java.util.Set<com.nos.core.entity.CmsUserSite> userSites) {
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof com.nos.core.entity.CmsSite)) return false;
		else {
			com.nos.core.entity.CmsSite cmsSite = (com.nos.core.entity.CmsSite) obj;
            return !(null == this.getId() || null == cmsSite.getId()) && (this.getId().equals(cmsSite.getId()));
		}
	}
