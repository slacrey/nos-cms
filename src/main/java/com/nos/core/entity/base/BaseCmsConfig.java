...
public abstract class BaseCmsConfig  implements Serializable {
	...
	// components
	 com.nos.core.entity.MarkConfig m_markConfig;
	 com.nos.core.entity.EmailConfig m_emailConfig;
	...
	public com.nos.core.entity.MarkConfig getMarkConfig () {
		return m_markConfig;
	}
	 ...
	 */
	public void setMarkConfig (com.nos.core.entity.MarkConfig m_markConfig) {
		this.m_markConfig = m_markConfig;
	}


	public com.nos.core.entity.EmailConfig getEmailConfig () {
	 ...
	 */
	public void setEmailConfig (com.nos.core.entity.EmailConfig m_emailConfig) {
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof com.nos.core.entity.CmsConfig)) return false;
		else {
			com.nos.core.entity.CmsConfig cmsConfig = (com.nos.core.entity.CmsConfig) obj;
