...
public abstract class BaseAuthentication  implements Serializable {
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof com.nos.core.entity.Authentication)) return false;
		else {
			com.nos.core.entity.Authentication authentication = (com.nos.core.entity.Authentication) obj;
            return !(null == this.getId() || null == authentication.getId()) && (this.getId().equals(authentication.getId()));
		}
	}
