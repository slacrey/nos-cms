...
public abstract class BaseCmsSiteCompany  implements Serializable {
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof com.nos.core.entity.CmsSiteCompany)) return false;
		else {
			com.nos.core.entity.CmsSiteCompany cmsSiteCompany = (com.nos.core.entity.CmsSiteCompany) obj;
            return !(null == this.getId() || null == cmsSiteCompany.getId()) && (this.getId().equals(cmsSiteCompany.getId()));
		}
	}
