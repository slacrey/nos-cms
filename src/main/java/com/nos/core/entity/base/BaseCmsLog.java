...
public abstract class BaseCmsLog  implements Serializable {
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof com.nos.core.entity.CmsLog)) return false;
		else {
			com.nos.core.entity.CmsLog cmsLog = (com.nos.core.entity.CmsLog) obj;
            return !(null == this.getId() || null == cmsLog.getId()) && (this.getId().equals(cmsLog.getId()));
		}
	}
