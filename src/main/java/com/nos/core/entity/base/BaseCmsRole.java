...
public abstract class BaseCmsRole  implements Serializable {
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof com.nos.core.entity.CmsRole)) return false;
		else {
			com.nos.core.entity.CmsRole cmsRole = (com.nos.core.entity.CmsRole) obj;
            return !(null == this.getId() || null == cmsRole.getId()) && (this.getId().equals(cmsRole.getId()));
		}
	}
