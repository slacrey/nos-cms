package com.nos.cms.entity.assist.base;
...
public abstract class BaseCmsGuestbook  implements Serializable {
	...
	public BaseCmsGuestbook (
		...
		com.nos.cms.entity.assist.CmsGuestbookCtg ctg,
		java.lang.String ip,
	...
	// one to one
	private com.nos.cms.entity.assist.CmsGuestbookExt ext;

	// many to one
	private com.nos.core.entity.CmsUser member;
	private com.nos.core.entity.CmsUser admin;
	private com.nos.core.entity.CmsSite site;
	private com.nos.cms.entity.assist.CmsGuestbookCtg ctg;
	 ...
	 */
	public com.nos.cms.entity.assist.CmsGuestbookExt getExt () {
		return ext;
	}
	 ...
	 */
	public void setExt (com.nos.cms.entity.assist.CmsGuestbookExt ext) {
		this.ext = ext;
	}
	 ...
	 */
	public com.nos.core.entity.CmsUser getMember () {
		return member;
	}
	 ...
	 */
	public void setMember (com.nos.core.entity.CmsUser member) {
		this.member = member;
	}
	 ...
	 */
	public com.nos.core.entity.CmsUser getAdmin () {
		return admin;
	}
	 ...
	 */
	public void setAdmin (com.nos.core.entity.CmsUser admin) {
		this.admin = admin;
	}
	 ...
	 */
	public com.nos.cms.entity.assist.CmsGuestbookCtg getCtg () {
		return ctg;
	}
	 ...
	 */
	public void setCtg (com.nos.cms.entity.assist.CmsGuestbookCtg ctg) {
		this.ctg = ctg;
	}
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof com.nos.cms.entity.assist.CmsGuestbook)) return false;
		else {
			com.nos.cms.entity.assist.CmsGuestbook cmsGuestbook = (com.nos.cms.entity.assist.CmsGuestbook) obj;
