...
public abstract class BaseCmsMessage  implements Serializable {
	...
	// many to one
	private com.nos.core.entity.CmsUser msgReceiverUser;
	private com.nos.core.entity.CmsUser msgSendUser;
	private com.nos.core.entity.CmsSite site;
	
	// collections
	private java.util.Set<com.nos.cms.entity.assist.CmsReceiverMessage> receiverMsgs;
	 ...
	 */
	public com.nos.core.entity.CmsUser getMsgReceiverUser () {
	 ...
	 */
	public void setMsgReceiverUser (com.nos.core.entity.CmsUser msgReceiverUser) {
	 ...
	 */
	public com.nos.core.entity.CmsUser getMsgSendUser () {
		return msgSendUser;
	}
	 ...
	 */
	public void setMsgSendUser (com.nos.core.entity.CmsUser msgSendUser) {
	...
	public java.util.Set<com.nos.cms.entity.assist.CmsReceiverMessage> getReceiverMsgs() {
		return receiverMsgs;
	}

	public void setReceiverMsgs(
			java.util.Set<com.nos.cms.entity.assist.CmsReceiverMessage> receiverMsgs) {
		this.receiverMsgs = receiverMsgs;
	}

	public boolean equals (Object obj) {
		if (null == obj) return false;
		if (!(obj instanceof com.nos.cms.entity.assist.CmsMessage)) return false;
		else {
			com.nos.cms.entity.assist.CmsMessage cmsMessage = (com.nos.cms.entity.assist.CmsMessage) obj;
